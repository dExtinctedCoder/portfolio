      ...
      <div className="py-24 pb-40 px-8 relative overflow-x-hidden grow basis-full md:px-16 md:flex md:items-center lg:px-24 lg:pb-48">
        <div className="flex items-center">
          ...
          <div className="absolute w-full h-full flex flex-wrap grow-0 justify-between gap-x-6 gap-y-6 items-center left-0 top-0 p-16 px-4">
            ...
            <span className={`w-20 hidden aspect-square ${theme === 'light' ? 'border-purple' : 'border-pink'} animate-spinner border-[6px] opacity-20 self-start lg:block`}></span>
            ...
            <span className={`w-8 hidden aspect-square ${theme === 'light' ? 'border-purple' : 'border-pink'} animate-spinner border-[6px] opacity-20 self-start lg:block`}></span>
            <span className={`w-12 hidden aspect-square ${theme === 'light' ? 'border-purple' : 'border-pink'} animate-spinner border-[6px] opacity-20 self-end lg:block`}></span>
            <span className={`w-20 hidden aspect-square ${theme === 'light' ? 'border-purple' : 'border-pink'} animate-spinner border-[6px] opacity-20 self-center lg:block`}></span>
            <span className={`w-12 aspect-square ${theme === 'light' ? 'border-purple' : 'border-pink'} animate-spinner border-[6px] opacity-20 self-end`}></span>
            <span className={`w-8 aspect-square ${theme === 'light' ? 'border-purple' : 'border-pink'} animate-spinner border-[6px] opacity-20 self-start`}></span>
          </div>
        </div>
