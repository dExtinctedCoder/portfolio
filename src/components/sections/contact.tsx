...
const Contact = () => {
  return (
    <section 
      id="contact__section"
      className="py-16 relative border-y-[6px] border-gold-light md:py-20"
    >
      ...
      >
        <div
          className='rounded-md w-[323px] text-white bg-gold-light dark:text-gold-light dark:bg-[#292929] md:w-1/3 md:text-center'
        ><a 
          role="button" 
        ...
        <div
          className='flex items-center w-[323px] gap-x-1 py-2 px-4 rounded-md text-white bg-gold-light dark:text-gold-light dark:bg-[#292929] md:w-1/3 md:justify-center'
